...
class BaseTrainer:
    ...
    """
    def __init__(self, model, criterions, metric_fns, optimizers, config):
        self.config = config
    ...
    def _save_checkpoint(self, epoch, save_best=False):
        ...
        if self.multi_model:
            for n, o in self.optimizers.items():
                optimizer_state_dict[n] = o.state_dict()
        else:
    ...
    def _resume_checkpoint(self, resume_path):
        ...
        if checkpoint['config']['optimizer'] != self.config['optimizer']:
            ...
            if self.multi_model:
                for n, o in checkpoint['optimizer'].items():
                    self.optimizers[n].load_state_dict(o)
            else:
