...
class Trainer(BaseTrainer):
    ...
    Trainer class
    """
    def __init__(self, model, criterions, metric_fns, optimizers, config, data_loader, valid_data_loader=None,
                 lr_scheduler=None, len_epoch=None):
        super().__init__(model, criterions, metric_fns, optimizers, config)
